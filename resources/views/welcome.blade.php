...
<section id="events" class="max-w-7xl mx-auto px-6 py-20">
    <div class="flex justify-between items-end mb-12">
        ...
        <div class="mb-8 flex gap-4 justify-center">
            ...
            <a href="/?category={{ $cat->slug }}" class="px-5 py-2 {{ request('category') == $cat->slug ? 'bg-indigo-600 text-white' : 'bg-indigo-100 text-indigo-700' }} rounded-xl font-bold hover:bg-indigo-600 hover:text-white transition">
                {{ $cat->name }}
            </a>
            @endforeach
        </div>
...
<section class="max-w-7xl mx-auto px-6 py-16">
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-4 flex flex-col items-center gap-3 hover:shadow-md transition">
